...
<script>
    export default {
      ...
      methods: {
        ...
        handleVisualizationOption(visualizationOption) {
          this.actualVisualizationOption = visualizationOption
          this.$emit("emitVisualizationOption", this.actualVisualizationOption)
        }
